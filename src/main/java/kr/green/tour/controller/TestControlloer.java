	...
	// 파싱할 tag
		...
		for(int temp = 0; temp < nList.getLength(); temp++){
			...
			if(nNode.getNodeType() == Node.ELEMENT_NODE){
				...
				System.out.println("홈페이지: " + getTagValue("lodgeHomepage", eElement));
				...
				place.setImg(getTagValue("lodgeMainImg", eElement));
				place.setName(getTagValue("lodgeNm", eElement));
				place.setTel(getTagValue("lodgeTel", eElement));
